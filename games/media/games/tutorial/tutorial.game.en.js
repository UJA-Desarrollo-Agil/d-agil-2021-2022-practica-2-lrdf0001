...
undum.game.situations = {
	...
	*/
	...
	"sentarse": new undum.SimpleSituation(
		...
		El Partido estuviera corrompido bajo su fachada de culto al esfuerzo y negación de placeres.</p>\
		<br>\
		...
		<br>\
		<p>―Eva (o Adán), y el tuyo es [Insertar nombre], tengo mis métodos― dice antes de que puedas\
		preguntar cómo lo sabe― Te llevo observando desde hace tiempo, mi intuición me decía que \
		estabas completamente en contra del partido. Y no me equivocaba.</p>\
		<br>\
		...
		al verla: una telepantalla con la cara del Gran Hermano.</p>\
		<br>\
		<p>―No es posible― susurra Eva con la voz quebrada y los ojos acuosos.</p>\
		<br>\
		<p>―Estáis detenidos― dice el Gran Hermano de forma inexpresiva.</p>\
		<br>\
		<p>Tras la sentencia, cinco agentes de la Policía del Pensamiento irrumpen en la habitación.\
